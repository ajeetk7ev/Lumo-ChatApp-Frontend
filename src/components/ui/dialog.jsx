...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-6 top-6 rounded-xl opacity-50 ring-offset-background transition-all hover:opacity-100 hover:bg-white/5 p-1.5 focus:outline-none disabled:pointer-events-none data-[state=open]:bg-white/5 data-[state=open]:text-gray-400">
        <X className="h-4 w-4" />
